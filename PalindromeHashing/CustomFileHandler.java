...
public class CustomFileHandler
{
	...
	public static final int NO_ADDED_LINE_BREAKS = 0, FORCE_ADD_LINE_BREAKS = 1, ADD_UNFOUND_LINE_BREAKS = 2;
	...
	public static boolean writeFile(String[] inFileLines, String fileName, int addLineBreaks)
	{
		...
		boolean successful = writeFile(fileLines, fileName, addLineBreaks);
	 ...
	 * @return Boolean flag which indicates if the file write was successful.
	 */
	public static boolean writeFile(ArrayList<String> fileLines, String fileName, boolean addLineBreaks)
	{
		return writeFile(fileLines, fileName, addLineBreaks ? FORCE_ADD_LINE_BREAKS : NO_ADDED_LINE_BREAKS);
	}
	...
	public static boolean writeFile(ArrayList<String> fileLines, String fileName, int addLineBreaks)
	{
		...
		try
		{
			...
			for (String line : fileLines)
				fileOut.write(line+
					(addLineBreaks == NO_ADDED_LINE_BREAKS ?
						"" :
